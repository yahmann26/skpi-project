...
class KegiatanDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('kategori', function ($kegiatan) {
            return $kegiatan->kategori->nama_kategori;
        })
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('nama_kegiatan')->width(100),
            Column::make('tingkat_kegiatan')->title('Tingkat')->width(50),
            Column::make('jabatan')->width(50),
            Column::make('bobot')->width(10),
