...
class PengaturanController extends Controller
{
    public function index()
    {
        ...
        $dataPengaturan = [
            ...
            'sk_pendirian_universitas' => Skpi::getSettingByName('sk_pendirian_universitas'),
            'sk_pendirian_universitas_en' => Skpi::getSettingByName('sk_pendirian_universitas_en'),
    ...
    private function __updateuniversitas(Request $request)
    {
        $request->validate([
            ...
            'sk_pendirian_universitas' => 'required',
            'sk_pendirian_universitas_en' => 'required',
        ...
        $skPendirianuniversitas = $request->input('sk_pendirian_universitas');
        $skPendirianuniversitasEn = $request->input('sk_pendirian_universitas_en');
        ...
        $dataPengaturan = [
            ...
            'sk_pendirian_universitas' => $skPendirianuniversitas,
            'sk_pendirian_universitas_en' => $skPendirianuniversitasEn,
