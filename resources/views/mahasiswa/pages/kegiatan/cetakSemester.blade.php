            ...
            <div style="display: flex; align-items: center;">
                ...
                <table border="0"
                    ...
                    <tr>
                        ...
                        <td style="width:85%; padding: 0; padding-top: 2mm; text-align: center; justify-content: space-between;">
                ...
                <table border="1"
                    ...
                    <thead style="font-weight: bold;">
                        <tr>
                            ...
                            <th>Kriteria Kegiatan</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php $no = 'A'; @endphp
                        @foreach ($kategori as $kategori => $kegiatanList)
                            <!-- Baris Kategori -->
                            <tr>
                            ...
                            @php $subNo = 1; @endphp
                            <!-- Daftar Kegiatan dalam Kategori -->
                            @foreach ($kegiatanList as $kegiatan)
                                <tr>
                                    <td></td>
                                    <td>{{ $subNo++ }}. {{ $kegiatan->nama }}</td>
                                </tr>
                            @endforeach
                            @php $no++; @endphp
                        @endforeach
