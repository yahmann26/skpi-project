                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $user->mahasiswa->nim }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Nama Lengkap</div>
                                    <div class="col-lg-9 col-md-8">{{ $user->mahasiswa->nama }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Program Studi</div>
                                    <div class="col-lg-9 col-md-8">{{ $user->mahasiswa->prodi->nama }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Tempat, Tanggal Lahir</div>
                                    <div class="col-lg-9 col-md-8">{{ $user->mahasiswa->tempat_lahir }} ,
                                        {{ \App\Helper\Skpi::dateIndo($user->mahasiswa->tgl_lahir) }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Tanggal Masuk</div>
                                    <div class="col-lg-9 col-md-8">
                                        {{ \App\Helper\Skpi::dateIndo($user->mahasiswa->tgl_masuk) }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Tanggal Lulus</div>
                                    <div class="col-lg-9 col-md-8">
                                        {{ \App\Helper\Skpi::dateIndo($user->mahasiswa->tgl_lulus) }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">No Ijazah</div>
                                    <div class="col-lg-9 col-md-8">{{ $user->mahasiswa->no_ijazah }}</div>
                                </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form id="profileEditForm" action="{{ route('mahasiswa.user.update-profile') }}"
                                    method="post">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="nim" type="number" class="form-control" id="nim"
                                                value="{{ $user->mahasiswa->nim }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="fullName" type="text" class="form-control" id="fullName"
                                                value="{{ $user->mahasiswa->nama }}" disabled>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form id="changePasswordForm" action="{{ route('mahasiswa.user.update-password') }}"
                                    method="post">
                                    @csrf
                                    @method('PUT')
