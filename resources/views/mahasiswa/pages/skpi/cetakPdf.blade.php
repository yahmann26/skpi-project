...
<body>
    ...
    {{-- <div id="page-header">
        <table border="0" style="width: 100%; border-collapse: collapse; border-spacing: 0; position: relative;">
            <tr>
                <td style="width: 15%; text-align: center; padding: 0;">
                    <img class="logo" src="data:image/png;base64,{{ $logoUniv }}" alt="University logo" width="100"
                        height="100">
                </td>
                <td style="color: #2F9B58; padding: 0; vertical-align: left;">
                    ...
                    <h3 style="font-size: 0.875rem; font-weight: 600; margin: 0; color: black; font-style: italic; ">
    ...
    <div>
        ...
        <table border="0"
            style="page-break-after:always; width: 100%; border-collapse: collapse; border-spacing: 0; margin-top: 0">
            @foreach ($kegiatan as $index => $k)
                <tr>
                    <td style="width: 5%; text-align: center; padding: 0;">
                    </td>
                    <td style="width: 2%; font-size: 12px; font-weight: normal;">
                        {{ $index + 1 }}.
                    </td>
                    ...
                    <td
                        style="width: 2%; font-size: 12px; font-style: italic; font-weight: normal; text-align: left; margin-top: 0; margin-bottom: 0;">
                        {{ $index + 1 }}.
                    </td>
                    <td style="width: 43%; text-align: left; vertical-align: top;">
                        <h1
