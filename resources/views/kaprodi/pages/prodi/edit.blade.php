                ...
                <div class="col-md-12">
                    <div class="card overflow-auto">
                        <div class="card-body">
                            ...
                            <form action="{{ route('kaprodi.prodi.update', ['id' => $detailData->id]) }}" method="post">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="jenjang_pendidikan_id" id="jenjang_pendidikan_id"
                                        ...
                                        @foreach ($jenjangPendidikan as $jp)
                                            <option value="{{ $jp->id }}"
                                                {{ $detailData->jenjang_pendidikan_id == $jp->id ? 'selected' : '' }}>
                                                {{ $jp->nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3 @error('bhs_pengantar_kuliah') is-invalid @enderror">
                                        <span class="input-group-text">&nbsp;ID</span>
                                        <input type="text" name="bhs_pengantar_kuliah" class="form-control"
                                            aria-describedby="bhs_pengantar_kuliah-addon" class="form-control"
                                            value="{{ $detailData->bhs_pengantar_kuliah }}" autofocus
                                ...
                                <div class="mb-3">
                                    <div class="input-group mb-3 @error('bhs_pengantar_kuliah_en') is-invalid @enderror">
                                        ...
                                        <input type="text" name="bhs_pengantar_kuliah_en" class="form-control"
                                            aria-describedby="bhs_pengantar_kuliah_en-addon" class="form-control"
                                            value="{{ $detailData->bhs_pengantar_kuliah_en }}" autofocus
                                            placeholder="Bahasa Penagntar Kuliah (english)">
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3 @error('sistem_penilaian') is-invalid @enderror">
                                        <span class="input-group-text">&nbsp;ID</span>
                                        <input type="text" name="sistem_penilaian" class="form-control"
                                            aria-describedby="sistem_penilaian-addon" class="form-control"
                                            value="{{ $detailData->sistem_penilaian }}" autofocus
                                ...
                                <div class="mb-3">
                                    <div class="input-group mb-3 @error('sistem_penilaian_en') is-invalid @enderror">
                                        ...
                                        <input type="text" name="sistem_penilaian_en" class="form-control"
                                            aria-describedby="sistem_penilaian_en-addon" class="form-control"
                                            value="{{ $detailData->sistem_penilaian_en }}" autofocus
                                            placeholder="Sistem Penilaian (english)">
                                    </div>
