    ...
    <div class="a4 border border-gray-300 p-6">
        ...
        <div class="ml-6 grid grid-cols-2 gap-6">
            <div>
                ...
                <h3 class="ml-2 text-xs bg-gray-300 p-1">SARJANA KOMPUTER : Teknik Informatika <br> (KKNI LEVEL 6)</h3>
            </div>
            <div>
                <h3 class="text-xs italic font-bold mb-2">1. Learning Outcomes</h3>
                <h3 class="ml-2 text-xs bg-gray-300 p-1">Informatics engineering Bachelor Level <br> (KKNI LEVEL 6)
                </h3>
            </div>
        </div>
            ...
            @foreach ($cpl as $item)
                <div>
                    @foreach ($item['subs'] as $sub)
                        <h3 class="ml-2 text-xs bg-gray-300 p-1 mt-2">{{ $sub['judul'] }}</h3>
                ...
                <div>
                    @foreach ($item['subs'] as $sub)
                        <h3 class="ml-2 text-xs bg-gray-300 p-1 mt-2">{{ $sub['judul_en'] }}</h3>
                        @if (isset($sub['list']) && is_array($sub['list']))
                            <ol class="ml-5 list-decimal text-xs" style="text-align: justify">
                                @foreach ($sub['list'] as $list)
                                    <li>
        ...
        <div class="ml-6 grid grid-cols-2 gap-6">
            ...
            <div class="text-left">
                ...
                <br><br><br>
                <p class="text-xs font-bold underline">NASYIIN FAQIH, S.T., M.T.</p>
                <p class="text-xs">NIDN: 0629077202</p>
            </div>
        </div>
