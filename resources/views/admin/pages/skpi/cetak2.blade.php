        ...
        <table border="0" style="width: 100%; border-collapse: collapse; border-spacing: 0; margin-top: 10px">
            @foreach ($kegiatan_default as $index => $item)
                <tr>
                    ...
                    <td style="width: 2%;">
                        <h1 style="font-size: 12px; font-weight: normal; text-align: left; margin-top: 0; margin-bottom: 0;">
                            {{ $index + 1 }}.
                        </h1>
                    </td>
                    ...
                    <td style="width: 43%; text-align: left; vertical-align: top;">
                        <h1 style="font-size: 12px; font-weight: normal; font-style: italic; text-align: left; margin-top: 0; margin-bottom: 0;">
