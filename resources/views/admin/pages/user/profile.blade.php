                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $user->uid }}</div>
                                </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form id="profileEditForm" action="{{ route('admin.user.update-profile') }}"
                                    method="post">
                                    @csrf
                                    @method('PUT')

                                    <div class="row mb-3">
                                        <label for="uid" class="col-md-4 col-lg-3 col-form-label">Username</label>
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form id="changePasswordForm" action="{{ route('admin.user.update-password') }}"
                                    method="post">
                                    @csrf
                                    @method('PUT')
