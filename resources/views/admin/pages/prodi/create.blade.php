                        ...
                        <form action="{{ route('admin.prodi.store') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenjang_pendidikan_id" id="jenjang_pendidikan_id"
                                    ...
                                    @foreach ($jenjang as $jp)
                                        <option value="{{ $jp->id }}"
                                            {{ old('jenjang_pendidikan_id') == $jp->id ? 'selected' : '' }}>
                                            {{ $jp->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3 @error('bhs_pengantar_kuliah') is-invalid @enderror">
                                    ...
                                    <input type="text" name="bhs_pengantar_kuliah" class="form-control" aria-describedby="bhs_pengantar_kuliah-addon"
                                        class="form-control" value="{{ old('bhs_pengantar_kuliah') }}" autofocus
                            ...
                            <div class="mb-3">
                                <div class="input-group mb-3 @error('bhs_pengantar_kuliah_en') is-invalid @enderror">
                                    ...
                                    <input type="text" name="bhs_pengantar_kuliah_en" class="form-control"
                                        aria-describedby="bhs_pengantar_kuliah_en-addon" class="form-control" value="{{ old('bhs_pengantar_kuliah_en') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="akreditasi" id="akreditasi"
                                    ...
                                    value="{{ old('akreditasi') }}" placeholder="Misal: A, B, dsb">
                                @error('akreditasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3 @error('sistem_penilaian') is-invalid @enderror">
                                    ...
                                    <input type="text" name="sistem_penilaian" class="form-control" aria-describedby="sistem_penilaian-addon"
                                        class="form-control" value="{{ old('sistem_penilaian') }}" autofocus
                            ...
                            <div class="mb-3">
                                <div class="input-group mb-3 @error('sistem_penilaian_en') is-invalid @enderror">
                                    ...
                                    <input type="text" name="sistem_penilaian_en" class="form-control"
                                        aria-describedby="sistem_penilaian_en-addon" class="form-control" value="{{ old('sistem_penilaian_en') }}"
                            ...
                            <div class="mb-3">
                                <label for="gelar" class="form-label" style="font-weight: bold;">Gelar <span class="text-danger">*</span></label>
                                <div class="input-group mb-3 @error('gelar') is-invalid @enderror">
                                    <span class="input-group-text">&nbsp;ID</span>
                                    <input type="text" name="gelar" class="form-control" aria-describedby="gelar-addon"
                                        class="form-control" value="{{ old('gelar') }}" autofocus placeholder="Gelar">
                                </div>
                                @error('gelar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
