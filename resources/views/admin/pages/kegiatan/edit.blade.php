                                ...
                                <select class="form-select" name="kategori_id" id="kategori_id">
                                    @foreach ($kategori as $kategori)
                                        <option value="{{ $kategori->id }}"
                                            {{ $kegiatan->kategori_id == $kategori->id ? 'selected' : ''}}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('nama_kegiatan') is-invalid @enderror"
                                    name="nama_kegiatan" value="{{ $kegiatan->nama_kegiatan }}" id="nama_kegiatan">
                                @error('nama_kegiatan')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('tingkat_kegiatan') is-invalid @enderror"
                                    name="tingkat_kegiatan" value="{{ $kegiatan->tingkat_kegiatan }}" id="tingkat_kegiatan">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('jabatan') is-invalid @enderror"
                                    name="jabatan" value="{{ $kegiatan->jabatan }}" id="jabatan">
                                @error('jabatan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('bobot') is-invalid @enderror"
                                    name="bobot" value="{{ $kegiatan->bobot }}" id="bobot">
                                @error('bobot')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
